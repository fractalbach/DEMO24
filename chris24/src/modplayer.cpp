...
void playModuleInit ( signed char * module );
...
// =======================================================================================
//  AUDIO HAX SO THAT I CAN USE THIS IN MY DEMO
// =======================================================================================

static int hax_playing;
static uint32_t hax_prevframe;
static long hax_result;
void playModuleRunThisEveryFrame();

void playModuleInit ( signed char * module ) {

	hax_result = micromod_initialise( module, SAMPLING_FREQ * OVERSAMPLE );
	if( hax_result == 0 )
	{
		print_module_info();
		samples_remaining = micromod_calculate_song_duration();
...
void playModuleRunThisEveryFrame() {
	...
	// Remember this frame
	hax_prevframe = currframe;

	if( samples_remaining <= 0 || hax_result != 0 )
		hax_playing = 0;
}